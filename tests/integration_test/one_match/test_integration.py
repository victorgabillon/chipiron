...
configs_base = [
    # random Player first to have a fast game
    {
        ...
        "base_script_args": {"profiling": False, "testing": True},
    },
    {
        "gui": False,
        "match_args": {
    ...
    # checking profiling
    {
        ...
        "base_script_args": {"profiling": True, "testing": True},
    },
...
configs_implementation = [
    ...
    {"implementation_args": {"use_board_modification": True, "use_rust_boards": False}},
    {"implementation_args": {"use_board_modification": False, "use_rust_boards": True}},
    {"implementation_args": {"use_board_modification": True, "use_rust_boards": True}},
]
...
configs_with_stock = [
    # stockfish
    {
        ...
        "match_args": {
            "seed": 11,
            "file_name_player_one": PlayerConfigFile.Stockfish,
            "file_name_player_two": PlayerConfigFile.Random,
