    ...
    *,
    ...
    filtered_nodes = tuple(
        TrainingNodeSnapshot(
            ...
            tree_value_scalar=node.tree_value_scalar,
            effective_value_scalar=node.effective_value_scalar,
            effective_value_source=node.effective_value_source,
            target_value_scalar=node.target_value_scalar,
...
def _snapshot_with_fitted_backups(
    ...
    nodes = tuple(
        TrainingNodeSnapshot(
            ...
            tree_value_scalar=node_values[node.node_id].backed_up_target,
            effective_value_scalar=node_values[node.node_id].backed_up_target,
            effective_value_source="tree_value",
            target_value_scalar=node_values[node.node_id].backed_up_target,
    ...
    snapshot = TrainingTreeSnapshot(
        ...
        nodes=tuple(
            TrainingNodeSnapshot(
                ...
                tree_value_scalar=row.target_value,
                effective_value_scalar=row.target_value,
                effective_value_source="tree_value",
                target_value_scalar=row.target_value,
