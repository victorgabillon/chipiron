...
shared_env="cd \"$REPO_ROOT\" && export PYTHONPATH=\"$CORAL_REPO_ROOT/src:$ATOMHEART_REPO_ROOT/src:$ANEMONE_REPO_ROOT/src:$REPO_ROOT/src:\${PYTHONPATH:-}\" && export MORPION_WORK_DIR=\"$MORPION_WORK_DIR\" && export MORPION_OPERATOR_RICH=\"$MORPION_OPERATOR_RICH\" && export MORPION_COLOR_RAW_LOGS=\"$MORPION_COLOR_RAW_LOGS\" && export MORPION_GROWTH_WORKER_MAX_CYCLES=\"$MORPION_GROWTH_WORKER_MAX_CYCLES\" && export MORPION_GROWTH_SHOW_RECAP=\"$MORPION_GROWTH_SHOW_RECAP\""
