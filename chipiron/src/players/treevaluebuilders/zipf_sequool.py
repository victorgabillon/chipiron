...
from src.players.treevaluebuilders.notations_and_statics import zipf_picks_random
...
class ZipfSequool(TreeAndValuePlayer):
    ...
    def choose_node_and_move_to_open(self):
        ...
        depth_picked, best_val = zipf_picks_random(ordered_list_elements=list_elements_,
                                                   bool_func=func_2)
