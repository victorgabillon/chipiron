...
pgn = open('/home/victor_old/pycharm/chipiron/data/lichess_db_standard_rated_2015-03.pgn')
...
while recorded_board < 10000000:
    ...
    if game is None or count_game % 10000 == 0:  # save
        # weird that an arry is given where a dictionary is expected
