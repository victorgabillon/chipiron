...
from Players.TreeAndValueBuilders.Trees.opening_instructions import OpeningInstructionsBatch
...
class Uniform(TreeAndValue):
    ...
    def create_tree(self, board):
        return MoveAndValueTree(self.environment, self.board_evaluator, self.color, self.arg, board)
