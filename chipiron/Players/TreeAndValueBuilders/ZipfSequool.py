...
from Players.TreeAndValueBuilders.Trees.descendants import SortedDescendants
from Players.TreeAndValueBuilders.Trees.Nodes.tree_node_with_descendants import NodeWithDescendantsNoUpdate
from Players.TreeAndValueBuilders.Trees.first_moves import FirstMoves
import math
...
class ZipfSequool(TreeAndValue):
    ...
    def create_tree(self, board):
        return ZipfSequoolTree(self.environment, self.board_evaluators_wrapper, self.color, self.arg, board)
