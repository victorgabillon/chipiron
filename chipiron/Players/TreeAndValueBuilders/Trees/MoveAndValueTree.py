...
from Players.TreeAndValueBuilders.Trees.Nodes.TreeNode import TreeNode
import pickle
from Players.TreeAndValueBuilders.Trees.Updates import UpdateInstructionsBatch
import settings
...
class MoveAndValueTree:
    ...
    def __init__(self, environment, board_evaluator, color, arg, starting_board=None):
        ...
        self.color = color  # todo is it used? is it redundans with tthe root node.player_to_move
