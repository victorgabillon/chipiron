...
class MinMaxEvaluationUpdater:
    ...
    def create_update_instructions_after_node_birth(
        ...
        """
        base_update_instructions: ValueUpdateInstructionsFromOneNode = ValueUpdateInstructionsFromOneNode(
    ...
    def perform_updates(
        ...
        updates_instructions_block = updates_instructions.value_updates_toward_one_parent_node
