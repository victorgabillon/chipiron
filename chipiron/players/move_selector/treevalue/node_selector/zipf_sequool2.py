...
from players.move_selector.treevalue.trees.descendants import Descendants
from players.move_selector.treevalue.nodes.tree_node_with_proportions import ProportionsNode
from players.move_selector.treevalue.nodes.tree_node_with_descendants import NodeWithDescendants
import math


class ZipfSequoolTreeNode2(ProportionsNode, IndexTreeNode):
    pass
...
class ZipfSequool2:
    ...
    def create_tree(self, board):
        return ZipfSequoolTree2(self.environment, self.board_evaluator, self.color_player, self.arg, board)
