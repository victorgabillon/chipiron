...
class ClassifiedBoards(Dataset):
...
# class MixBoards(Dataset):
#
#     def __init__(self):
#         print('Loading the dataset...')
#         self.classify_boards = ClassifiedBoards()
#         self.next_boards = NextBoards()
#         print('Dataset loaded.')
#
#     def __len__(self):
#         return len(self.classify_boards) + len(self.next_boards)
#
#     def __getitem__(self, idx):
#         if random.random() > .5:
#             return self.classify_boards[idx] , return self.next_boards[idx]
