...
class NN4Pytorch:
    ...
    def __init__(self, folder):
        ...
        self.optimizer = optim.SGD(self.net.parameters(), lr=.00001, momentum=0.9)

    def init_weights(self):

        try:
            with open('chipiron/runs/players/boardevaluators/NN1_pytorch/' + self.folder + '/paramtest_45.pt',
                      'rb') as fileNNR:
                print('%%%%%%', self.folder)
    ...
    def train_one_example(self, input_layer, target_value_0_1, target_input_layer):
        ...
        if target_value_0_1 is None:
            ...
            real_target_value_0_1 = 1-self.net(target_input_layer)
            self.net.train()
        else:
